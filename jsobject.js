...
var car = {
    ...
    info: function() {
        ...
        document.write( "car color :" +this.price, "<br>");
    }
};
...
var data1 = yellowArr.pop(); //pop 가장 마지막 값을 정한다
...
yellowArr.unshift(data1); //unshift 데이터 제일 맨 앞값
console.log(yellowArr);
...
if (check1 && check2) {
    ...
    document.write("e-mail 형식이 잘못되었습니다.")
}
document.write("<hr>");
...
//익명 함수
var sum2 = function(number, number2) {
